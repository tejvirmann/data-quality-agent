"""Landing page HTML for the docs endpoint."""
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .schema-comment { color: var(--muted) !important; }
...
<div class="hero">
  ...
  <svg class="hero-eyeball" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g stroke="#8B0000" stroke-width="0.6" opacity="0.25">
      <path d="M54 60 Q50 55 45 53"/><path d="M54 60 Q50 65 44 68"/>
      <path d="M66 60 Q70 55 76 54"/><path d="M66 60 Q70 65 75 67"/>
    </g>
